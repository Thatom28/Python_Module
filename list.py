...
# print(marks)
# print(marks.pop(3))  # removes the last element in the list  unless you specify#mutate
# print(marks)
# marks[3] = 45
# print(marks)
# lenth = len(marks)
...
print(marks_copy)
print(marks)
print(id(marks), id(marks_copy))  #different memory adresses
#--------------------Copy using slicing(shallow copy) the have different memory addresses------------------
marks_copy2 = marks[:]
print(marks_copy2)
print(id(marks), id(marks_copy2))
marks_copy3 = marks[1:4]
print(marks_copy3)
...
print(subjects)
print(" ,".join(subjects))  #To not return with []
